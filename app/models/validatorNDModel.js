let ValidatorND = function () {
  ...
  this.checkIdDuplicate = function (acc, userArray) {
    var index = userArray.findIndex((nguoiDung) => {
      return nguoiDung.taiKhoan == acc;
    });
    ...
    if (index == -1) {
      ...
      document.getElementById("tbTaiKhoan").innerHTML = "Tài khoản đã tồn tại";
      return false;
    }
  };
